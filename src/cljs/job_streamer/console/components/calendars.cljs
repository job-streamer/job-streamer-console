                     ...
                     [:div.ui.row
                      [:div.ui.column
                       (case mode
                         ...
                         :detail (om/build calendar-detail-view (:cal-name app) {:opts {:calendars-channel calendars-channel}})
                         ...
                         (cond
                           ...
                           :default (om/build calendar-list-view (:calendars app) {:opts {:calendars-channel calendars-channel}})))
