...
(function(ma){var w,l,r=function(a,b){if("function"===typeof document.addEventListener||d.isIE8()){var e=!1;try{e=a instanceof Element}catch(n){e=!!a&&1===e.nodeType}e||"string"===typeof a||(b=a);var f=this,g=f.classes,k=f.settings=d.merge(f.defaults,{attachTo:a},b||{}),e=f.container=d.make("div",{"class":g.container}),r=f.calendars=[],p=l().day(k.weekStart),u,v=[],m,q,C,w;m=[];var D;q=0;u=k.months;d.isIE8()&&d.addClassName(e,"ie8");for(q=7;q--;)v.push(p.format(k.columnHeaderFormat)),p.add(1,"days");
H(f);if("object"===typeof k.subscribe)for(q in k.subscribe)k.subscribe.hasOwnProperty(q)&&f.subscribe(q,k.subscribe[q]);f._sel=[];k.selected&&f.setSelected(k.selected,!1);u=k.viewStartDate?l(k.viewStartDate,k.format):0<f._sel.length?l(f._sel[0]):l();f.viewStartDate=u.date(1);(u={past:k.months-1,"today-past":k.months-1,any:2<k.months?Math.floor(k.months/2):0,"today-future":0,future:0}[this.settings.direction])&&l().month()==l(f.viewStartDate).month()&&(f.viewStartDate=l(f.viewStartDate).subtract({M:u}).date(1));
f.defaultView=l(f.viewStartDate);if("function"===typeof k.blackout)f.blackout=k.blackout;else if(k.blackout){var F=A(k.blackout,k.parseSplitDelimiter,k.format);f.blackout=function(a){a=l(a).startOf("day").yearDay();if(1>a||!f._sel)return!1;for(var e=F.length;e--;)if(F[e].startOf("day").yearDay()===a)return!0;return!1}}else f.blackout=function(){return!1};f.direction=f.directions[k.direction]?f.directions[k.direction]:f.directions.any;for(u=Math.max(k.months,1);u--;){m=d.make("div",{"class":g.calendar},
e);m.setAttribute("data-cal-index",u);1<k.months&&(u==Math.max(k.months-1,1)?d.addClassName(m,g.monthFirst):0===u?d.addClassName(m,g.monthLast):d.addClassName(m,g.monthMiddle));q=d.make("div",{"class":g.title},m);k.useYearNav||d.addClassName(q,g.disableYearNav);d.make("a",{"class":g.previousYear},q);d.make("a",{"class":g.previousMonth},q);d.make("a",{"class":g.nextYear},q);d.make("a",{"class":g.nextMonth},q);p=d.make("span",{"class":g.caption},q);C=d.make("div",{"class":g.header},m);q=0;do D=d.make("span",
{},C),D.innerHTML=v[q];while(7>++q);C=d.make("div",{"class":g.days},m);q=0;m=[];do"week"==k.mode?(0===q%7&&(w=d.make("div",{"class":g.week+" clearfix"},C),m.push(w)),d.make("span",{},w)):m.push(d.make("span",{},C));while(42>++q);r.push({caption:p,days:m});u&&d.make("div",{"class":g.monthSeparator},e)}f.draw();d.addEvent(e,"mousedown",function(a,e){var b;if(d.hasClassName(e,g.nextMonth))f.disableNext||!1===f.publish("view-changed",f,["next-month"])||(f.viewStartDate.add(1,"months"),f.draw());else if(d.hasClassName(e,
g.previousMonth))f.disablePreviousMonth||!1===f.publish("view-changed",f,["previous-month"])||(f.viewStartDate.subtract("months",1),f.draw());else if(d.hasClassName(e,g.nextYear))f.disableNext||!1===f.publish("view-changed",f,["next-year"])||(f.viewStartDate.add(1,"years"),f.draw());else if(d.hasClassName(e,g.previousYear))f.disablePreviousMonth||!1===f.publish("view-changed",f,["previous-year"])||(f.viewStartDate.subtract("years",1),f.draw());else if((d.hasClassName(e.parentNode,g.days)||d.hasClassName(e.parentNode,
g.week))&&d.hasClassName(e,g.dayActive)&&(b=e.getAttribute("data-date"))){if(b=l(b,k.dayAttributeFormat).hours(12),!1!==f.publish("date-clicked",f,[b]))switch(k.mode){case "multiple":f.addSelected(b)||f.removeSelected(b);break;case "range":f.addSelected(b);break;case "week":f.weekSelected(b);break;default:f.addSelected(b)}}else d.hasClassName(e.parentNode,g.week)&&(b=e.getAttribute("data-date"))&&(b=l(b,k.dayAttributeFormat).hours(12),!1!==f.publish("date-clicked",f,[b])&&"week"==k.mode&&f.weekSelected(b));
return!1});(k.attachTo=d.$(k.attachTo))&&k.attachTo.appendChild(e)}};r.prototype={defaults:{attachTo:null,months:1,weekStart:0,direction:"any",directionScrolling:!0,viewStartDate:null,blackout:null,selected:null,mode:"single",dayOutOfMonthClickable:!1,format:null,subscribe:null,columnHeaderFormat:"dd",titleFormat:"MMMM, YYYY",dayNumberFormat:"D",dayAttributeFormat:"YYYY-MM-DD",parseSplitDelimiter:/,\s*|\s+-\s+/,rangeDelimiter:" - ",multipleDelimiter:", ",useYearNav:!0,dateClassMap:{}},classes:{container:"kalendae",
...
else if("today-future"===m.direction||"future"===m.direction)a>11+m.months?(this.disablePreviousYear=!1,d.removeClassName(this.container,e.disablePreviousYear)):(this.disablePreviousYear=!0,d.addClassName(this.container,e.disablePreviousYear))}}};var A=function(a,b,e){var n=[];"string"===typeof a?a=a.split(b):d.isArray(a)||(a=[a]);b=a.length;var f=0,g;do a[f]&&(g=l(a[f],e).hours(12),g.isValid()&&n.push(g));while(++f<b);return n};window.Kalendae=r;var d=r.util={isIE8:function(){return!(!/msie 8./i.test(navigator.appVersion)||
...
var k=this,E=k.classes;f=k.settings=d.merge(k.defaults,b);this._events={};f.attachTo=window.document.body;f.selected?n=!0:f.selected=e.value;r.call(k,f);f.closeButton&&(f=d.make("a",{"class":E.closeButton},k.container),d.addEvent(f,"click",function(){e.blur()}));n&&(e.value=k.getSelected());n=k.container;var p=!1;n.style.display="none";d.addClassName(n,E.positioned);this._events.containerMouseDown=d.addEvent(n,"mousedown",function(a,b){p=!0});this._events.documentMousedown=d.addEvent(window.document,
"mousedown",function(a,b){p=!1});this._events.inputFocus=d.addEvent(e,"focus",function(){g=!0;k.setSelected(this.value);g=!1;k.show()});this._events.inputBlur=d.addEvent(e,"blur",function(){p&&d.isIE8()?(p=!1,e.focus()):k.hide()});this._events.inputKeyup=d.addEvent(e,"keyup",function(a){g=!0;(a=A(this.value,k.settings.parseSplitDelimiter,k.settings.format))&&a.length&&a[0]&&1E3<a[0].year?k.setSelected(this.value):(k.setSelected("",null),k.viewStartDate=l(k.defaultView),k.draw());g=!1});(E=d.scrollContainer(e))&&
d.addEvent(E,"scroll",function(a){e.blur()});k.subscribe("change",function(){g||(e.value=k.getSelected(),d.fireEvent(e,"change"))})}};r.Input.prototype=d.merge(r.prototype,{defaults:d.merge(r.prototype.defaults,{format:"MM/DD/YYYY",side:"bottom",closeButton:!0,offsetLeft:0,offsetTop:0}),classes:d.merge(r.prototype.classes,{positioned:"k-floating",closeButton:"k-btn-close"}),show:function(){var a=this.container,b=a.style,e=this.input,n=d.getPosition(e),f=d.scrollContainer(e),g=f?f.scrollTop:0,f=f?
f.scrollLeft:0,k=this.settings;b.display="";switch(k.side){case "left":b.left=n.left-d.getWidth(a)+k.offsetLeft-f+"px";b.top=n.top+k.offsetTop-g+"px";break;case "right":b.left=n.left+d.getWidth(e)-f+"px";b.top=n.top+k.offsetTop-g+"px";break;case "top":b.left=n.left+k.offsetLeft-f+"px";b.top=n.top-d.getHeight(a)+k.offsetTop-g+"px";break;case "bottom right":b.left=n.left-d.getWidth(a)+d.getWidth(e)+k.offsetLeft+"px";b.top=n.top+d.getHeight(e)+k.offsetTop-g+"px";break;default:b.left=n.left+k.offsetLeft-
f+"px",b.top=n.top+d.getHeight(e)+k.offsetTop-g+"px"}b.position=d.isFixed(e)?"fixed":"absolute";this.publish("show",this)},hide:function(){this.container.style.display="none";this.publish("hide",this)},destroy:function(){var a=this.container,b=this.input;d.removeEvent(a,"mousedown",this._events.containerMousedown);d.removeEvent(window.document,"mousedown",this._events.documentMousedown);d.removeEvent(b,"focus",this._events.inputFocus);d.removeEvent(b,"blur",this._events.inputBlur);d.removeEvent(b,
"keyup",this._events.inputKeyup);a.remove()}});var H=function(a){a||(a=this);var b=a.c_||{};a.publish=function(a,d,f){for(var g=(a=b[a])?a.length:0,k;g--;)if(k=a[g].apply(d,f||[]),"boolean"===typeof k)return k};a.subscribe=function(a,d,f){b[a]||(b[a]=[]);f?b[a].push(d):b[a].unshift(d);return[a,d]};a.unsubscribe=function(a){var d=b[a[0]];a=a[1];for(var f=d?d.length:0;f--;)d[f]===a&&d.splice(f,1)}};(function(a){function b(c,x){return function(a){return p(c.call(this,a),x)}}function e(c,x){return function(a){return this.lang().ordinal(c.call(this,
a),x)}}function d(){}function f(c){k(this,c)}function g(c){var x=c.years||c.year||c.y||0,a=c.months||c.month||c.M||0,b=c.weeks||c.week||c.w||0,e=c.days||c.day||c.d||0,d=c.hours||c.hour||c.h||0,f=c.minutes||c.minute||c.m||0,k=c.seconds||c.second||c.s||0,h=c.milliseconds||c.millisecond||c.ms||0;this._input=c;this._milliseconds=h+1E3*k+6E4*f+36E5*d;this._days=e+7*b;this._months=a+12*x;this._data={};this._bubble()}function k(c,x){for(var a in x)x.hasOwnProperty(a)&&(c[a]=x[a]);return c}function l(c){return 0>
c?Math.ceil(c):Math.floor(c)}function p(c,x){for(var a=c+"";a.length<x;)a="0"+a;return a}function r(c,a,b,e){var d=a._milliseconds,f=a._days;a=a._months;var k,g;d&&c._d.setTime(+c._d+d*b);if(f||a)k=c.minute(),g=c.hour();f&&c.date(c.date()+f*b);a&&c.month(c.month()+a*b);d&&!e&&h.updateOffset(c);if(f||a)c.minute(k),c.hour(g)}function v(c,a){var b=Math.min(c.length,a.length),e=Math.abs(c.length-a.length),d=0,f;for(f=0;f<b;f++)~~c[f]!==~~a[f]&&d++;return d+e}function m(c){return c?Y[c]||c.toLowerCase().replace(/(.)s$/,
"$1"):c}function q(c){if(!c)return h.fn._lang;if(!B[c]&&P)try{require("./lang/"+c)}catch(a){return h.fn._lang}return B[c]}function w(c){return c.match(/\[.*\]/)?c.replace(/^\[|\]$/g,""):c.replace(/\\/g,"")}function A(c){var a=c.match(Q),b,e;b=0;for(e=a.length;b<e;b++)a[b]=y[a[b]]?y[a[b]]:w(a[b]);return function(d){var f="";for(b=0;b<e;b++)f+=a[b]instanceof Function?a[b].call(d,c):a[b];return f}}function D(c,a){function b(a){return c.lang().longDateFormat(a)||a}for(var e=5;e--&&R.test(a);)a=a.replace(R,
b);J[a]||(J[a]=A(a));return J[a](c)}function F(c,a){switch(c){case "DDDD":return Z;case "YYYY":return aa;case "YYYYY":return ba;case "S":case "SS":case "SSS":case "DDD":return ca;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":return da;case "a":case "A":return q(a._l)._meridiemParse;case "X":return ea;case "Z":case "ZZ":return K;case "T":return fa;case "MM":case "DD":case "YY":case "HH":case "hh":case "mm":case "ss":case "M":case "D":case "d":case "H":case "h":case "m":case "s":return ga;
default:return new RegExp(c.replace("\\",""))}}function N(c){c=((K.exec(c)||[])[0]+"").match(ha)||["-",0,0];var a=+(60*c[1])+~~c[2];return"+"===c[0]?-a:a}function O(c){var a,b=[];if(!c._d){for(a=0;7>a;a++)c._a[a]=b[a]=null==c._a[a]?2===a?1:0:c._a[a];b[3]+=~~((c._tzm||0)/60);b[4]+=~~((c._tzm||0)%60);a=new Date(0);c._useUTC?(a.setUTCFullYear(b[0],b[1],b[2]),a.setUTCHours(b[3],b[4],b[5],b[6])):(a.setFullYear(b[0],b[1],b[2]),a.setHours(b[3],b[4],b[5],b[6]));c._d=a}}function I(c){var a=c._f.match(Q),b=
c._i,e,d;c._a=[];for(e=0;e<a.length;e++)if((d=(F(a[e],c).exec(b)||[])[0])&&(b=b.slice(b.indexOf(d)+d.length)),y[a[e]]){var f=c,k=void 0,h=f._a;switch(a[e]){case "M":case "MM":h[1]=null==d?0:~~d-1;break;case "MMM":case "MMMM":k=q(f._l).monthsParse(d);null!=k?h[1]=k:f._isValid=!1;break;case "D":case "DD":case "DDD":case "DDDD":null!=d&&(h[2]=~~d);break;case "YY":h[0]=~~d+(68<~~d?1900:2E3);break;case "YYYY":case "YYYYY":h[0]=~~d;break;case "a":case "A":f._isPm=q(f._l).isPM(d);break;case "H":case "HH":case "h":case "hh":h[3]=
~~d;break;case "m":case "mm":h[4]=~~d;break;case "s":case "ss":h[5]=~~d;break;case "S":case "SS":case "SSS":h[6]=~~(1E3*("0."+d));break;case "X":f._d=new Date(1E3*parseFloat(d));break;case "Z":case "ZZ":f._useUTC=!0,f._tzm=N(d)}null==d&&(f._isValid=!1)}b&&(c._il=b);c._isPm&&12>c._a[3]&&(c._a[3]+=12);!1===c._isPm&&12===c._a[3]&&(c._a[3]=0);O(c)}function H(c,a,b,d,e){return e.relativeTime(a||1,!!b,c,d)}function G(c,a,b){a=b-a;b-=c.day();b>a&&(b-=7);b<a-7&&(b+=7);c=h(c).add("d",b);return{week:Math.ceil(c.dayOfYear()/
7),year:c.year()}}function S(c){var b=c._i,d=c._f;if(null===b||""===b)return null;"string"===typeof b&&(c._i=b=q().preparse(b));if(h.isMoment(b))c=k({},b),c._d=new Date(+b._d);else if(d)if("[object Array]"===Object.prototype.toString.call(d)){var b=c,e,g,l=99,m;for(m=0;m<b._f.length;m++)e=k({},b),e._f=b._f[m],I(e),d=new f(e),e=v(e._a,d.toArray()),d._il&&(e+=d._il.length),e<l&&(l=e,g=d);k(b,g)}else I(c);else if(g=c,b=g._i,d=ia.exec(b),b===a)g._d=new Date;else if(d)g._d=new Date(+d[1]);else if("string"===
typeof b)if(b=g._i,d=ja.exec(b)){g._f="YYYY-MM-DD"+(d[2]||" ");for(d=0;4>d;d++)if(T[d][1].exec(b)){g._f+=T[d][0];break}K.exec(b)&&(g._f+=" Z");I(g)}else g._d=new Date(b);else"[object Array]"===Object.prototype.toString.call(b)?(g._a=b.slice(0),O(g)):g._d=b instanceof Date?new Date(+b):new Date(b);return new f(c)}function U(c,a){h.fn[c]=h.fn[c+"s"]=function(c){var b=this._isUTC?"UTC":"";return null!=c?(this._d["set"+b+a](c),h.updateOffset(this),this):this._d["get"+b+a]()}}function ka(c){h.duration.fn[c]=
function(){return this._data[c]}}function V(c,a){h.duration.fn["as"+c]=function(){return+this/a}}for(var h,z=Math.round,t,B={},P="undefined"!==typeof module&&module.exports,ia=/^\/?Date\((\-?\d+)/i,la=/(\-)?(\d*)?\.?(\d+)\:(\d+)\:(\d+)\.?(\d{3})?/,Q=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g,R=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,ga=/\d\d?/,ca=/\d{1,3}/,Z=/\d{3}/,aa=/\d{1,4}/,ba=/[+\-]?\d{1,6}/,
da=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,K=/Z|[\+\-]\d\d:?\d\d/i,fa=/T/i,ea=/[\+\-]?\d+(\.\d{1,3})?/,ja=/^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/,T=[["HH:mm:ss.S",/(T| )\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],ha=/([\+\-]|\d\d)/gi,L=["Date","Hours","Minutes","Seconds","Milliseconds"],M={Milliseconds:1,Seconds:1E3,
Minutes:6E4,Hours:36E5,Days:864E5,Months:2592E6,Years:31536E6},Y={ms:"millisecond",s:"second",m:"minute",h:"hour",d:"day",w:"week",M:"month",y:"year"},J={},W="DDD w W M D d".split(" "),X="MDHhmswW".split(""),y={M:function(){return this.month()+1},MMM:function(c){return this.lang().monthsShort(this,c)},MMMM:function(c){return this.lang().months(this,c)},D:function(){return this.date()},DDD:function(){return this.dayOfYear()},d:function(){return this.day()},dd:function(c){return this.lang().weekdaysMin(this,
...
10),2)},SSS:function(){return p(this.milliseconds(),3)},Z:function(){var c=-this.zone(),a="+";0>c&&(c=-c,a="-");return a+p(~~(c/60),2)+":"+p(~~c%60,2)},ZZ:function(){var c=-this.zone(),a="+";0>c&&(c=-c,a="-");return a+p(~~(10*c/6),4)},z:function(){return this.zoneAbbr()},zz:function(){return this.zoneName()},X:function(){return this.unix()}};W.length;)t=W.pop(),y[t+"o"]=e(y[t],t);for(;X.length;)t=X.pop(),y[t+t]=b(y[t],2);y.DDDD=b(y.DDD,3);d.prototype={set:function(c){var a,b;for(b in c)a=c[b],"function"===
...
week:function(c){return G(c,this._week.dow,this._week.doy).week},_week:{dow:0,doy:6}};h=function(c,a,b){return S({_i:c,_f:a,_l:b,_isUTC:!1})};h.utc=function(c,a,b){return S({_useUTC:!0,_isUTC:!0,_l:b,_i:c,_f:a})};h.unix=function(c){return h(1E3*c)};h.duration=function(c,a){var b=h.isDuration(c),d="number"===typeof c,e=b?c._input:d?{}:c,f=la.exec(c);d?a?e[a]=c:e.milliseconds=c:f&&(d="-"===f[1]?-1:1,e={y:0,d:~~f[2]*d,h:~~f[3]*d,m:~~f[4]*d,s:~~f[5]*d,ms:~~f[6]*d});f=new g(e);b&&c.hasOwnProperty("_lang")&&
(f._lang=c._lang);return f};h.version="2.1.0";h.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";h.updateOffset=function(){};h.lang=function(c,a){if(!c)return h.fn._lang._abbr;a?(a.abbr=c,B[c]||(B[c]=new d),B[c].set(a)):B[c]||q(c);h.duration.fn._lang=h.fn._lang=q(c)};h.langData=function(c){c&&c._lang&&c._lang._abbr&&(c=c._lang._abbr);return q(c)};h.isMoment=function(c){return c instanceof f};h.isDuration=function(c){return c instanceof g};h.fn=f.prototype={clone:function(){return h(this)},valueOf:function(){return+this._d+
6E4*(this._offset||0)},unix:function(){return Math.floor(+this/1E3)},toString:function(){return this.format("ddd MMM DD YYYY HH:mm:ss [GMT]ZZ")},toDate:function(){return this._offset?new Date(+this):this._d},toISOString:function(){return D(h(this).utc(),"YYYY-MM-DD[T]HH:mm:ss.SSS[Z]")},toArray:function(){return[this.year(),this.month(),this.date(),this.hours(),this.minutes(),this.seconds(),this.milliseconds()]},isValid:function(){null==this._isValid&&(this._isValid=this._a?!v(this._a,(this._isUTC?
...
G(this,1,4).year;return null==a?b:this.add("y",a-b)},week:function(a){var b=this.lang().week(this);return null==a?b:this.add("d",7*(a-b))},isoWeek:function(a){var b=G(this,1,4).week;return null==a?b:this.add("d",7*(a-b))},weekday:function(a){var b=(this._d.getDay()+7-this.lang()._week.dow)%7;return null==a?b:this.add("d",a-b)},isoWeekday:function(a){return null==a?this.day()||7:this.day(this.day()%7?a:a-7)},lang:function(b){if(b===a)return this._lang;this._lang=q(b);return this}};for(t=0;t<L.length;t++)U(L[t].toLowerCase().replace(/s$/,
""),L[t]);U("year","FullYear");h.fn.days=h.fn.day;h.fn.months=h.fn.month;h.fn.weeks=h.fn.week;h.fn.isoWeeks=h.fn.isoWeek;h.fn.toJSON=h.fn.toISOString;h.duration.fn=g.prototype={_bubble:function(){var a=this._milliseconds,b=this._days,d=this._months,e=this._data;e.milliseconds=a%1E3;a=l(a/1E3);e.seconds=a%60;a=l(a/60);e.minutes=a%60;a=l(a/60);e.hours=a%24;b+=l(a/24);e.days=b%30;d+=l(b/30);e.months=d%12;b=l(d/12);e.years=b},weeks:function(){return l(this.days()/7)},valueOf:function(){return this._milliseconds+
864E5*this._days+this._months%12*2592E6+31536E6*~~(this._months/12)},humanize:function(a){var b=+this,d;d=!a;var e=this.lang(),f=z(Math.abs(b)/1E3),h=z(f/60),k=z(h/60),g=z(k/24),l=z(g/365),f=45>f&&["s",f]||1===h&&["m"]||45>h&&["mm",h]||1===k&&["h"]||22>k&&["hh",k]||1===g&&["d"]||25>=g&&["dd",g]||45>=g&&["M"]||345>g&&["MM",z(g/30)]||1===l&&["y"]||["yy",l];f[2]=d;f[3]=0<b;f[4]=e;d=H.apply({},f);a&&(d=this.lang().pastFuture(b,d));return this.lang().postformat(d)},add:function(a,b){var d=h.duration(a,
b);this._milliseconds+=d._milliseconds;this._days+=d._days;this._months+=d._months;this._bubble();return this},subtract:function(a,b){var d=h.duration(a,b);this._milliseconds-=d._milliseconds;this._days-=d._days;this._months-=d._months;this._bubble();return this},get:function(a){a=m(a);return this[a.toLowerCase()+"s"]()},as:function(a){a=m(a);return this["as"+a.charAt(0).toUpperCase()+a.slice(1)+"s"]()},lang:h.fn.lang};for(t in M)M.hasOwnProperty(t)&&(V(t,M[t]),ka(t.toLowerCase()));V("Weeks",6048E5);
h.duration.fn.asMonths=function(){return(+this-31536E6*this.years())/2592E6+12*this.years()};h.lang("en",{ordinal:function(a){var b=a%10;return a+(1===~~(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th")}});P&&(module.exports=h);"undefined"===typeof ender&&(this.moment=h);"function"===typeof define&&define.amd&&define("moment",[],function(){return h});this.moment=h}).call("undefined"===typeof r?window:r);if(!r.moment)if(window.moment)r.moment=window.moment;else throw"Kalendae requires moment.js. You must use kalendae.standalone.js if moment is not available on the page.";
l=r.moment;l.fn.yearDay=function(a){var b=Math.floor(this._d/864E5);return"undefined"===typeof a?b:this.add({d:a-b})};w=r.moment().startOf("day");"undefined"===typeof jQuery||"function"!==typeof document.addEventListener&&!d.isIE8()||(jQuery.fn.kalendae=function(a){this.each(function(b,d){"INPUT"===d.tagName?jQuery(d).data("kalendae",new r.Input(d,a)):jQuery(d).data("kalendae",new r(jQuery.extend({},{attachTo:d},a)))});return this})})();
